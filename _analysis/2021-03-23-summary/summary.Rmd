...
Download the main lecture slides:

- Slides link (coming soon) <i class="fa fa-file-pdf" title="PDF"></i>
...
But a typical epidemiological dataset might have one row for each subject (as in the `diamonds` example dataset).
