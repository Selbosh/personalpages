...
- [James's example script](resources/baseline_tables2.R) <i class="fab fa-r-project" title=".R"></i>
- [Stevie's slides](resources/Stevie summarising data.pptx) <i class="fas fa-file-powerpoint" title=".pptx"></i>
